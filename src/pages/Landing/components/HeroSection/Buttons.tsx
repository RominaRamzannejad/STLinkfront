...
const Buttons = () => {
    return (
        <div>
            <NavLink to={'/login'} className='absolute top-80 left-80 ml-10 cursor-pointer transition-colors rounded-full w-30 pr-8 pl-8 pt-3 pb-1 border-none hover:bg-blue-700 text-blue-100 bg-blue-600 h-7'> Try it now </NavLink>
